...
public class InteractionForRandom03 : MonoBehaviour
{
    ...
    private static InteractionForRandom03 _instance = null;

    public static InteractionForRandom03 Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = FindObjectOfType<InteractionForRandom03>();
    ...
    private void openPuzzle()
    {
        ...
        if (con == false)
        {
            PuzzleUIForRandom03.Instance.Puzzle();
            con = true;
        }
        else
        {
            PuzzleUIForRandom03.Instance.QuitPuzzle();
            con = false;
        }
    }
