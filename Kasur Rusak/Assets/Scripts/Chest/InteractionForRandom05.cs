...
public class InteractionForRandom05 : MonoBehaviour
{
    ...
    private static InteractionForRandom05 _instance = null;

    public static InteractionForRandom05 Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = FindObjectOfType<InteractionForRandom05>();
    ...
    private void openPuzzle()
    {
        ...
        if (con == false)
        {
            PuzzleUIForRandom05.Instance.Puzzle();
            con = true;
        }
        else
        {
            PuzzleUIForRandom05.Instance.QuitPuzzle();
            con = false;
        }
    }
