...
public class InteractionForRandom : MonoBehaviour
{
    ...
    private static InteractionForRandom _instance = null;

    public static InteractionForRandom Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = FindObjectOfType<InteractionForRandom>();
    ...
    private void openPuzzle()
    {
        ...
        if (con == false)
        {
            PuzzleUIForRandom.Instance.Puzzle();
            con = true;
        }
        else
        {
            PuzzleUIForRandom.Instance.QuitPuzzle();
            con = false;
        }
    }
