...
public class InteractionForRandom02 : MonoBehaviour
{
    ...
    private static InteractionForRandom02 _instance = null;

    public static InteractionForRandom02 Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = FindObjectOfType<InteractionForRandom02>();
    ...
    private void openPuzzle()
    {
        ...
        if (con == false)
        {
            PuzzleUIForRandom02.Instance.Puzzle();
            con = true;
        }
        else
        {
            PuzzleUIForRandom02.Instance.QuitPuzzle();
            con = false;
        }
    }
